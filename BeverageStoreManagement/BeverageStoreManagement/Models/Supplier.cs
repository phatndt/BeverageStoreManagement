...
namespace BeverageStoreManagement.Models
{
    class Supplier
    {
        ...
        public string EmailSupplier { get => emailSupplier; set => emailSupplier = value; }
        public bool IsDelete { get => isDelete; set => isDelete = value; }

        public Supplier() { }
        public Supplier(int idSupplier, string nameSupplier, string addressSupplier, string phoneSupplier, string emailSupplier, bool isDelete)
        {
